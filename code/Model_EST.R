...
require(raster)
require(rgdal)
ccg.spoly<-readRDS("D:/OneDrive - Nexus365/WORK/Document/RESEARCH/COVID19/07_PAPERWORK_20200611/SUBMISSION/2nd major revision/REVISE_ANALYSIS/ccg.spoly.rda")
crs(ccg.spoly) <- CRS("+init=epsg:27700")
